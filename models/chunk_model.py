...
class ChunkModel(BaseModel):
    ...
    - embedding: Optional list of floats representing the vector embedding of the chunk.
    - metadata: Optional dictionary to store any additional metadata (e.g., hash, source url).
