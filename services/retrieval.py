    ...
    try:
        ...
        response = client.models.generate_content(
            ...
            contents=(
                ...
                "Given the student's short query, your task is to add helpful search keywords.\n\n"
                "KNOWN acronyms in this domain:\n"
                "- OPPE = Online Proctored Practice Examination\n"
                "- GAA = Graded Assignment Average\n"
                "- AQET = Academic Qualifying Eligibility Test\n"
                "- CGPA = Cumulative Grade Point Average\n"
                "- BS = Bachelor of Science\n"
                "- SCT = Supplementary Course Test\n"
                ...
                "- QE = Qualifier Exam\n\n"
                "RULES:\n"
                "1. If you recognize the acronym from the list above, expand it.\n"
                "2. If you do NOT recognize an acronym, keep it EXACTLY as-is. Do NOT guess.\n"
                "3. Add 2-3 contextual search keywords related to the topic (exam, eligibility, process, etc.).\n"
                "4. Return ONLY the expanded search query, nothing else.\n\n"
                f"Query: {query}"
            ),
